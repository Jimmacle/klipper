...
class ADXL345:
    ...
    def _build_config(self):
        ...
        self.query_adxl345_end_cmd = self.mcu.lookup_query_command(
            "query_adxl345 oid=%c clock=%u rest_ticks=%u",
            "adxl345_end oid=%c end_time=%u limit_count=%hu sequence=%hu",
    ...
    def _handle_adxl345_start(self, params):
        self.samples_start1 = self._clock_to_print_time(params['start_time'])
        self.samples_start2 = self._clock_to_print_time(params['end_time'])
    ...
    def do_start(self, rate):
        ...
        self.spi.spi_send([REG_BW_RATE | REG_MOD_MULTI, QUERY_RATES[rate], 0x8])
        # Setup samples
